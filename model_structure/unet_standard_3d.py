...
class VGGBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, act_func=nn.SELU(), use_drop=0):
        ...
        self.conv1 = nn.Conv3d(in_channels, middle_channels, 3, stride=1, padding=1)
        self.bn1 = nn.BatchNorm3d(middle_channels)
        self.conv2 = nn.Conv3d(middle_channels, out_channels, 3, stride=1, padding=1)
        self.bn2 = nn.BatchNorm3d(out_channels)
        self.drop = nn.Dropout3d(use_drop)
